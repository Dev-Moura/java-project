...
const Crud = () => {
    ...
    const deleteUser = () => {
        // let _Users = (user as any)?.filter((val: any) => val.id !== user.id);
        // setUsers(_Users);
        // setDeleteUsersDialog(false);
        // setUser(emptyUser);
        // toast.current?.show({
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={usersDialog} style={{ width: '450px' }} header="user Details" modal className="p-fluid" footer={userDialogFooter} onHide={hideDialog}>                         
                    <Column field="name" header="Name" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}>
                    </Column>
